...
const Settings = () => {
  ...
  const navigateToProject = ()=>{
    navigate("https://github.com/Azmeerabhagyasree/WeatherApp");
  }

  const navigateToGithub = () =>{
    navigate("https://github.com/Azmeerabhagyasree");
  }
      ...
      <section className="container-fluid width-toggle-5 m-auto">
        ...
        <section className="support-developer d-flex align-items-start justify-content-center w-100 flex-column">
          ...
          <section className="sponsor-me text-muted text-start">
            ...
            Hi, I'm Azmeera Bhagya Sree. I built this weather app in 2023 to
